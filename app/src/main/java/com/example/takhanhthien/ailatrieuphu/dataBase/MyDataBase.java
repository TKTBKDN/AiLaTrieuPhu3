...
/**
 * Created by ThanhBeoNe on 10/28/2016.
 */
...
//        File file= new File(PATH);
        Log.d("Kaka","hehe"+PATH);
        Activity activity = (Activity) context;

        String outFileName = activity.getApplicationInfo().dataDir + "/databases/" + DV_NAME;
        File file= new File(outFileName);
        Log.d("Kaka2","hehe"+outFileName);
        if (file.exists()){
           Log.d("Kaka","hehe");
           return;
       }
        ...
        try {
            ...
            while (count!=-1){
                ...
                inputStream.read(b);
                Log.d("Kaka","hehe"+inputStream.read(b));
            }
            outputStream.close();
            inputStream.close();
        } catch (Exception e) {
    ...
    public ArrayList<Question> getData(){
        ...
        openDataBase();
        //database=LibDatabase.initDatabase(this,DV_NAME);
